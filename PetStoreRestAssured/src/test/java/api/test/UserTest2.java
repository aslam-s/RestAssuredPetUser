...
public class UserTest2 {
	...
	void testPostuser() {
		...
		Response rescreate = UserEndPoints2.userpoints(userpayload);
	...
	void testgetusername() {
		...
		Response resget = UserEndPoints2.readUsername(this.userpayload.getUsername());
		resget.then().log().all();
	...
	void testPutuser() {
		...
		userpayload.setEmail(f.internet().emailAddress());
		//
		Response resput = UserEndPoints2.updateuser(this.userpayload.getUsername(), userpayload);
		resput.then().log().all();
	...
	void testdeleteusername() {
		...
		Response resdel = UserEndPoints2.deleteUser(this.userpayload.getUsername());
		resdel.then().log().all();
